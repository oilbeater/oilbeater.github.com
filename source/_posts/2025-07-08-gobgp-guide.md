...
这样基本上 MetalLB，Calico 的基础 BGP 能力就可以测试了。如果想配更复杂的模式，比如 [Router Reflector](https://github.com/osrg/gobgp/blob/master/docs/sources/route-reflector.md)，[EVPN](https://github.com/osrg/gobgp/blob/master/docs/sources/evpn.md) 那就再去翻 [GoBGP 的文档](https://github.com/osrg/gobgp?tab=readme-ov-file#documentation)吧。